    ...
    <div class="humberger__menu__wrapper">
        ...
        <div class="humberger__menu__widget">
            <div class="header__top__right__language">
                <img src="{{asset('frontview/img/language.png')}}" alt="">
                <div>English</div>
                        ...
                        <div class="header__top__right">
                            ...
                            <div class="header__top__right__language">
                             ...
                             <div class="header__top__right__auth">
                                ...
                                <a style="margin-right: -13px;" href="{{ route('register') }}"><i class="fa fa-user"></i>Register</a>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="header__logo">
                        <a href="{{url('/')}}"><img src="{{asset('frontview/img/logo.png')}}" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-6">
                ...
                <div class="col-lg-3">
                    <div class="header__cart">
                        ...
                        <ul>
                            <li><a href="#"><i class="fa fa-heart"></i> <span>1</span></a></li>
                            <li><a href="{{route('cart.cart')}}"><i class="fa fa-shopping-bag"></i> <span>{{$quantity}}</span></a></li></ul>
