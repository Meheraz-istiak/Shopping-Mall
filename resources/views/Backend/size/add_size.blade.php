        ...
        <div class="col-sm-4">
            <div class="card">
                <div class="card-header">
                    ...
                    <span id="addB">Add Size</span>
                    <span id="updateB">update Size</span>

                </div>
                <div class="card-body">
                    <div class="form-group">
                        <label for="Category">Category</label>
                        <input type="text" class="form-control" id="size_name" aria-describedby="emailHelp" placeholder="Enter the Category Name" name="">
                    </div>
...
function datatable() {
          ...
          var data = "";
           $.each(response, function(key,value)
           {
            var cat = (value.status==1)?'open': 'close';
             ...
             data = data +"<td>"+value.size_name+"</td>"
             data = data +"<td>"+cat+"</td>"
             data = data +"<td>"
 ...
 $.ajax({
   type:"POST",
   dataType:"json",
   data:{size_name:size_name,status:status},
