        ...
        <div class="col-sm-4">
            <div class="card">
                <div class="card-header">
                    ...
                    <span id="addB">Add Color</span>
                    <span id="updateB">update Color</span>

                </div>
                <div class="card-body">
                    <div class="form-group">
                        <label for="color">Color</label>
                        <input type="text" class="form-control" id="color_name"  data-role="tagsinput"aria-describedby="emailHelp" placeholder="Enter the Category Name" name="">
                    </div>
          ...
          var data = "";
           $.each(response, function(key,value)
           {
            var cat = (value.status==1)?'open': 'close';
             ...
             data = data +"<td>"+value.color_name+"</td>"
             data = data +"<td>"+cat+"</td>"
             data = data +"<td>"
